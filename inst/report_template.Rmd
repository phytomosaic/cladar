...
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| *Pseudotsuga menziesii* | Growth | `decrease/increase/flat` | `zzz` | `zzz` | `zzz` |
| *Pseudotsuga menziesii* | Survival | `decrease/increase/flat` | `zzz` | `zzz` | `zzz` |
| *Pinus ponderosa* | Growth | `decrease/increase/flat` | `zzz` | `zzz` | `zzz` |
| *Pinus ponderosa* | Survival | `decrease/increase/flat` | `zzz` | `zzz` | `zzz` |
| *Acer glabrum* | Growth | `decrease/increase/flat` | `zzz` | `zzz` | `zzz` |
| *Acer glabrum* | Survival | `decrease/increase/flat` | `zzz` | `zzz` | `zzz` |
